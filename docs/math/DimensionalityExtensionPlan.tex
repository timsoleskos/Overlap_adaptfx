...
Stage~A and log-NIG regardless of hyperparameters.  Improvement can only come from
the 4~patients where models differ; the Student-$t$ tails help high-variability
patients and hurt near-zero-overlap patients (log-floor effect at
$\log(0 + 0.1) \approx -2.30$\,nat), netting close to zero.
